...
using RealWorldStocks.Client.ViewModels;
using RealWorldStocks.Client.ViewModels.Home;
using RealWorldStocks.Client.ViewModels.StockDetails;

namespace RealWorldStocks.Client.Framework
{
