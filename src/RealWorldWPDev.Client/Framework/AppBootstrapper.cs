...
using RealWorldWPDev.Client.ViewModels;
using RealWorldWPDev.Client.ViewModels.Home;
using RealWorldWPDev.Client.ViewModels.StockDetails;

namespace RealWorldWPDev.Client.Framework
{
	public class AppBootstrapper : PhoneBootstrapper
	{
        ...
        {
            LogManager.GetLog = type => new DebugLog(DebugLog.LogThreshold.Info);
