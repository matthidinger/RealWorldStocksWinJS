...
namespace RealWorldStocks.Core.Models
{
        ...
        where TItem : class
    {
        ...
        {
            var json = await PlatformAdapter.Current.Settings.ReadAsync(StorageFilename);
...
#if !DEBUG
                    PlatformAdapter.Current.Settings.DeleteAsync(StorageFilename);
#endif
                }
            }
        }
        ...
        public async Task PersistDataAsync()
        {
            try
            {
                ...
                await PlatformAdapter.Current.Settings.SaveAsync(StorageFilename, json);
            }
            catch (Exception)
            {
